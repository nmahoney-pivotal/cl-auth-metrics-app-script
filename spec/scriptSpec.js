describe('getTeamMembers', function() {
  beforeEach(function() {
    this.clAuthMetricsSpreadsheet = jasmine.createSpyObj('clAuthMetricsSpreadsheet', ['getSheetByName']);
  ...
  it('gets the "Team Members" Sheet', function() {
    getTeamMembers(this.clAuthMetricsSpreadsheet, this.logger);
  ...
  it('returns the team members from the "Team Members" Sheet', function() {
    expect(getTeamMembers(this.clAuthMetricsSpreadsheet, this.logger)).toEqual(this.teamMembers);
  });
